...
```bash
go get -u github.com/EasyPost/easypost-go/v5
```
...
Library documentation can be found on the web at [GoDoc](https://pkg.go.dev/github.com/EasyPost/easypost-go/v5).
...
```golang
import "github.com/EasyPost/easypost-go/v5"
