...
func (c *ClientTests) TestPickupRetrieve() {
	...
	assert.Equal(reflect.TypeOf(&Pickup{}), reflect.TypeOf(retrievePickup))
...
func (c *ClientTests) TestPickupBuy() {
	...
	assert.Equal(reflect.TypeOf(&Pickup{}), reflect.TypeOf(boughtPickup))
...
func (c *ClientTests) TestPickupCancel() {
	...
	assert.Equal(reflect.TypeOf(&Pickup{}), reflect.TypeOf(cancelledPickup))
