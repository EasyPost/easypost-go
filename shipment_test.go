...
func (c *ClientTests) TestShipmentCreate() {
	...
	assert.Equal(reflect.TypeOf(&Shipment{}), reflect.TypeOf(shipment))
...
func (c *ClientTests) TestShipmentRetrieve() {
	...
	assert.Equal(reflect.TypeOf(&Shipment{}), reflect.TypeOf(retrievedShipment))
...
func (c *ClientTests) TestShipmentRegenerateRates() {
	...
	assert.Equal(reflect.TypeOf([]*Rate{}), reflect.TypeOf(rates))
...
func (c *ClientTests) TestShipmentCreateEmptyObjects() {
	...
	shipmentData.CustomsInfo = &CustomsInfo{}
	shipmentData.CustomsInfo.CustomsItems = []*CustomsItem{}
...
func (c *ClientTests) TestShipmentCreateTaxIdentifier() {
	...
	shipmentData := c.fixture.BasicShipment()
	shipmentData.TaxIdentifiers = []*TaxIdentifier{c.fixture.TaxIdentifier()}
...
func (c *ClientTests) TestShipmentCreateWithIds() {
	...
	shipment, err := client.CreateShipment(
		&Shipment{
			FromAddress: &Address{ID: fromAddress.ID},
			ToAddress:   &Address{ID: toAddress.ID},
