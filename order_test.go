...
func (c *ClientTests) TestOrderCreate() {
	...
	assert.Equal(reflect.TypeOf(&Order{}), reflect.TypeOf(order))
...
func (c *ClientTests) TestOrderRetrieve() {
	...
	assert.Equal(reflect.TypeOf(&Order{}), reflect.TypeOf(retrievedOrder))
...
func (c *ClientTests) TestOrderGetRates() {
	...
	assert.Equal(reflect.TypeOf([]*Rate{}), reflect.TypeOf(ratesList))
...
func (c *ClientTests) TestOrderLowestRate() {
	...
	assert.Equal("11.40", lowestRate.Rate)
	...
	assert.Equal("14.48", lowestRate.Rate)
	assert.Equal("USPS", lowestRate.Carrier)
